    ...
    <div id="main">
      ...
      <form class="text" name="addlangs" action="" method="POST" onsubmit="return validateAdd(addlangs)">
        <table border="0" width="98%">
          <tr>
            <td align="left">
                <b><label for="source">Available Languages in the catalog:</label></b><br/>
                <a href="uclalangs.jsp">View only languages taught at UCLA</a>.            </td>
            <td align="left">&nbsp;</td>
            <td align="left">
                <b><label for="langs">Selected Languages</label></b>            </td>
          </tr>
          <tr>
            <td width="45%" align="left" valign="middle" style="border:0;">
              <select name="source" size="15" multiple="yes" style="width: 300px">
                <c:forEach var="theLang" items="${langDisplay.allLangs}">
                  <option value="${theLang.code}">${theLang.language}</option>
                </c:forEach>
              </select>            </td>
            ...
            <td width="45%" valign="middle" style="border:0;"><select name="langs" size="15" multiple="yes" style="width: 250px">
